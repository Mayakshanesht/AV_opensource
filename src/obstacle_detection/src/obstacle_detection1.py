...
class ObstacleDetector(object):
    ...
    def setup_yolo(self):
        class_names = []
        with open("/home/mayur/catkin_ws3/src/obstacle_detection/src/weights/classes.txt", "r") as f:
            self.class_names = [cname.strip() for cname in f.readlines()]
        self.net = cv2.dnn.readNet("/home/mayur/catkin_ws3/src/obstacle_detection/src/weights/yolov4-tiny.cfg", "/home/mayur/catkin_ws3/src/obstacle_detection/src/weights/yolov4-tiny.weights")
